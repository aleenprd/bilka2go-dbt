...
,STAGING AS (
  SELECT
    ...
    IMAGE_URL,
    CASE  
      WHEN LOWER(PRODUCER) LIKE '% g%'  THEN NULL
      WHEN LOWER(PRODUCER) LIKE '% stk' THEN NULL
      WHEN LOWER(PRODUCER) LIKE '% l' THEN NULL
      WHEN LOWER(PRODUCER) LIKE '% kg' THEN NULL
      WHEN LOWER(PRODUCER) LIKE '% ml' THEN NULL
      ELSE PRODUCER 
    END AS PRODUCER,
    CASE 
